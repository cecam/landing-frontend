...
const LoginForm:FC<IForm> = ({handleChange, onSubmit, setFormStatus, email, password}) => {
    ...
    return(
        <form 
            ...
            onSubmit={onSubmit}
        >
            <h1 className="text-3xl text-[#333]">Iniciar sesión</h1>
            <Input 
                id="email"
                name="email"
                type="text"
            ...
            <button onClick={() => setFormStatus('signup')}>ya tengo una cuenta</button>
        </form>
    )
}
